...
bool FRAM::isConnected() {
  return this->write(nullptr, 0) == i2c::ERROR_OK;
}

// Запись/чтение базовых типов через _writeBlock/_readBlock
